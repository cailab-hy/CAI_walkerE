...
from legged_lab.assets.tienkung_walkerE import TIENKUNG_WALKER_E_CFG
...
class TienKungWalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/tienkung_walkerE/datasets/motion_visualization/walk.txt"]
    device: str = "cuda:0"
    scene: BaseSceneCfg = BaseSceneCfg(
        max_episode_length_s=20.0,
        num_envs=4096,
        env_spacing=2.5,
        robot=TIENKUNG_WALKER_E_CFG,
...
class TienKungWalkAgentCfg(RslRlOnPolicyRunnerCfg):
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/tienkung_walkerE/datasets/motion_amp_expert/walk.txt"]
