...
class TienKungRunWithSensorFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/tienkung_walkerE/datasets/motion_visualization/run.txt"]
    device: str = "cuda:0"
...
class TienKungRunWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/tienkung_walkerE/datasets/motion_amp_expert/run.txt"]
